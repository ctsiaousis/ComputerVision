...
Η υβριδική εικόνα προκύπτει απο το άθροισμα δυο φιλτραρισμένων εικόνων. Η μία προκύπτει απο την εφαρμογή του gaussian φίλτρου στην εικόνα με αποτέλεσμα να κρατάμε τις χαμηλές συχνότητες, και η άλλη προκύπτει απο την εφαρμοφή του gaussian φίλτρου και ύστερα αφαίρεση του αποτελέσματος απο την αρχική εικόνα με αποτέλεσμα να κρατάμε τις υψηλές συχνότητες.

Χρησιμοποιούμε διαφορετική συχνότητα αποκοπής για το βαθυπερατό και το υψηπερατό φίλτρο ώστε να υπάρχει ένα κενό στις συχνότητες και να είναι πιο ευδιάκριτες οι δύο εικόνες στο υβριδικό αποτέλεσμα.
