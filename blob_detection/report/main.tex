...
Η πρώτη εικόνα κάθε οκτάβας υπολογίζεται με υποδειγματοληψία της προηγούμενης οκτάβας εκτός απο την πρώτη οκτάβα που δημιουργείται με διπλασιασμό της αρχικής εικόνας με linar interpolation.
...
Επίσης επιλέξαμε $3$ οκτάβες, άρα έχουμε $n = 3 \cdot 3 = 9$ επίπεδα στα οποία κάναμε αναζήτηση extrema.

Το scale-space αποθηκεύεται σε ένα cell array με διαστάσεις $num\_of\_octaves \times s+2$
\begin{verbatim}
scale_space = cell(num_of_octaves, s+2);
\end{verbatim}
Κάθε στοιχείο του cell array περιέχει μια εικόνα.
