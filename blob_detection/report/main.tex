...
\subsubsection{efficient μέθοδος φιλτραρίσματος}
Υλοποιήσαμε μια εναλλακτική μέθοδο φιλτραρίσματος για την δημιουργία του scale-space.
Κάνουμε downsample την εικόνα κατα $1/k^{i-1}$, μετά φιλτράρουμε και τέλος κάνουμε upsample κατα $k^{i-1}$ ώστε να επιστρέψουμε στο αρχικό μέγεθος
γιατί για την εύρεση των extrema πρέπει όλα τα layers μιας οκτάβας να έχουν τις ίδιες διαστάσεις.
...
πολλαπλασιασμένο με $\frac{2^{o-1}}{2}$ και επι μια σταθερά $\sqrt{2}$:
\[r =  \sqrt{2} k^{i-1} \sigma \cdot \frac{2^{o-1}}{2}\]
...
Με τη χρήση της boolean μεταβλητής efficient, διαλέγουμε την μέθοδος φιλτραρίσματος (efficient μέθοδος).
...
Παρατηρήσαμε ότι η efficient μέθοδος δεν βελτιώνει τον χρόνο δημιουργίας του scale-space ούτε τον συνολικό χρόνο εκτέλεσης.
Θα βλέπαμε βελτίωση αν δεν είχαμε οκτάβες γιατί τότε τα φίλτρα μας θα ήταν πολύ μεγάλα.
Επίσης στην υλοποίησή μας η εύρεση των extrema κυριαρχεί στο συνολικό χρόνος εκτέλεσης οπότε οποιαδήποτε βελτίωση στον χρόνο δημιουργίας του scale space δεν έχει νόημα.
