...
\begin{figure}[H]
  \includegraphics[width=16cm,trim={0 2cm 0 2cm},clip]{../output/3_positive.jpg}
...
\begin{figure}[H]
  \includegraphics[width=16cm,trim={0 2cm 0 2cm},clip]{../output/3_negative.jpg}
...
\begin{figure}[H]
  \includegraphics[width=16cm,trim={0 4cm 0 4cm},clip]{../output/3_result_1.jpg}
  \caption{faces\_1b.jpg}
\end{figure}

\begin{figure}[H]
  \includegraphics[width=16cm,trim={3cm 1cm 3cm 1cm},clip]{../output/3_result_2.jpg}
  \caption{faces\_1b.jpg rotated $90^{\circ}$}
\end{figure}

\begin{figure}[H]
  \includegraphics[width=16cm,trim={0 3cm 0 3cm},clip]{../output/3_result_3.jpg}
  \caption{faces\_1b.jpg scaled x2}
\end{figure}

\begin{figure}[H]
  \includegraphics[width=16cm,trim={2cm 2cm 2cm 2cm},clip]{../output/3_result_4.jpg}
  \caption{faces2.jpg}
\end{figure}
